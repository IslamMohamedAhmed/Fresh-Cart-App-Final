    ...
    <tr>
      <td>
        ...
        <table border="0" cellspacing="0" cellpadding="0" style="color:#0f3462; font-family: sans-serif;">
          ...
          <tr>
            <td>
              <a href="${process.env.BASE_URL}/users-auth/verify/${token}" type="button" style="background-color:#36b445; color:white; padding:15px 97px; outline: none; display: block; margin: auto; border-radius: 31px;
